...
@Component(
	property = {
		"ddm.form.field.type.name=" + DDMFormFieldTypeConstants.LOCALIZABLE_PHONE_NUMBER,
		"ddm.form.field.type.system=true"
	},
	service = DDMFormFieldType.class
)
public class LocalizablePhoneNumberDDMFormFieldType
	extends BaseDDMFormFieldType {

	@Override
	public String getESModule() {
		return "{LocalizablePhoneNumber} from " +
