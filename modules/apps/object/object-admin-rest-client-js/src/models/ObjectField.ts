 ...
 */
	...
	export class ObjectField {
			...
			"businessType"?: 'Aggregation' | 'Assignee' | 'Attachment' | 'AutoIncrement' | 'Boolean' | 'Date' | 'DateTime' | 'Decimal' | 'Email' | 'Encrypted' | 'Formula' | 'Integer' | 'LongInteger' | 'LongText' | 'MultiselectPicklist' | 'PhoneNumber' | 'Picklist' | 'PrecisionDecimal' | 'Relationship' | 'RichText' | 'Text';
			"defaultValue"?: string;
	...
	static "attributeTypeMap": Array<{
		...
		},
		{
			...
			name: "businessType",
			type: "'Aggregation' | 'Assignee' | 'Attachment' | 'AutoIncrement' | 'Boolean' | 'Date' | 'DateTime' | 'Decimal' | 'Email' | 'Encrypted' | 'Formula' | 'Integer' | 'LongInteger' | 'LongText' | 'MultiselectPicklist' | 'PhoneNumber' | 'Picklist' | 'PrecisionDecimal' | 'Relationship' | 'RichText' | 'Text'",
		},
		{
