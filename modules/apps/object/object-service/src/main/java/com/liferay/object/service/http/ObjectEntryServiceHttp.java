...
public class ObjectEntryServiceHttp {
	...
	public static void deleteTrashEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ObjectEntryServiceUtil.class, "deleteTrashEntry",
				_deleteTrashEntryParameterTypes5);
	...
	public static com.liferay.object.model.ObjectEntry moveEntryToTrash(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ObjectEntryServiceUtil.class, "moveEntryToTrash",
				_moveEntryToTrashParameterTypes21);
	...
	public static com.liferay.object.model.ObjectEntry partialUpdateObjectEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_partialUpdateObjectEntryParameterTypes22);
	...
	private static final Class<?>[] _deleteTrashEntryParameterTypes5 =
	...
	private static final Class<?>[] _moveEntryToTrashParameterTypes21 =
		new Class[] {
			long.class, com.liferay.object.model.ObjectEntry.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _partialUpdateObjectEntryParameterTypes22 =
		new Class[] {
